...
var UnitedUnits = ["res://Army/UnitedNetworks/UN_PeaceKeeper.tscn","res://Army/UnitedNetworks/Diplomat.tscn","res://Army/UnitedNetworks/Light Array.tscn","res://Army/UnitedNetworks/Unity Walker.tscn"]
